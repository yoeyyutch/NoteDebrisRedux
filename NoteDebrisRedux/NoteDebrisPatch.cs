...

{
	...
	{
		public static void Prefix(ref Transform initTransform, ref Vector3 cutPoint, ref Vector3 cutNormal, ref Vector3 force, ref float lifeTime)
		{
			if (!Plugin.ModEnabled && !Plugin.DebuggingEnabled) return;
